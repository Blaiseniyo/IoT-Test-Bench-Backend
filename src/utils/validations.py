...
connection_args.add_argument("username",type=str, help="Username is required")
connection_args.add_argument("password",type=str, help="Password is required")
...
test_broker_args.add_argument("username",type=str, help="Username is required")
test_broker_args.add_argument("password",type=str, help="Password is required")
